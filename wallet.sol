...
contract SmartContractWallet {
    ...
    function proposeNewOwner(address payable _newOwner) public {
        require(guardians[msg.sender], "You are not the owner.");
    ...
    function transfer(address payable _to, uint _amount, bytes memory _payload) public returns (bytes memory){
        //(msg.sender == owner, "You are not the owner.Aborting process.");
        if(msg.sender != owner) {
            require(isAllowedToSend[msg.sender], "You are not allowed to send from this smart contarct.");
